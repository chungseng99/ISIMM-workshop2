							...
							<c:choose>
								...
								<c:otherwise>
									...
									<li><a class="page-link"
										href='<c:out value="${pageContext.request.contextPath}/feePage/${url}" />'>Prev</a></li>
								</c:otherwise>
							</c:choose>
							<c:forEach begin="1" end="${feeList.pageCount}" step="1"
								...
								<c:choose>
									...
									<c:otherwise>
										...
										<li><a class="page-link"
											href='<c:out value="${pageContext.request.contextPath}/feePage/${url}" />'>${tagStatus.index}</a></li>
									</c:otherwise>
								</c:choose>
							</c:forEach>
							<c:choose>
								...
								<c:otherwise>
									...
									<li><a class="page-link"
										href='<c:out value="${pageContext.request.contextPath}/feePage/${url}" />'>Next</a></li>
								</c:otherwise>
							</c:choose>
						</ul>
					</div>
