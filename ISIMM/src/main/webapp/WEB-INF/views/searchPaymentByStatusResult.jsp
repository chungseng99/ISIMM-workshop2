		...
		<section class="wrapper site-min-height">
			...
			<div class="row mt">
				...
				<a
					...
					<h1>Search Result</h1>
					<c:set value="${payment}" var="paymentList" />
							...
							<c:choose>
								...
								<c:otherwise>
									...
									<li><a class="page-link"
										href='<c:out value="${pageContext.request.contextPath}/searchPaymentByStatus/${url}?searchPaymentByStatus=${search}&submit=Search" />'>Prev</a></li>
								</c:otherwise>
							</c:choose>
							<c:forEach begin="1" end="${paymentList.pageCount}" step="1"
								...
								<c:choose>
									...
									<c:otherwise>
										...
										<li><a class="page-link"
											href='<c:out value="${pageContext.request.contextPath}/searchPaymentByStatus/${url}?searchPaymentByStatus=${search}&submit=Search" />'>${tagStatus.index}</a></li>
									</c:otherwise>
								</c:choose>
							</c:forEach>
							<c:choose>
								...
								<c:otherwise>
									...
									<li><a class="page-link"
										href='<c:out value="${pageContext.request.contextPath}/searchPaymentByStatus/${url}?searchPaymentByStatus=${search}&submit=Search" />'>Next</a></li>
								</c:otherwise>
							</c:choose>
						</ul>
					</div>
