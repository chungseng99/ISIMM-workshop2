		...
		<div id="sidebar" class="nav-collapse ">
			...
			<ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu"><a href="javascript:;"> <i
					...
					<ul class="sub">
						<li class="active"><a
							href="${pageContext.request.contextPath}/studentPage">Teacher
								List</a></li>
						<li><a
							...
							<c:choose>
								...
								<c:otherwise>
									...
									<li><a class="page-link"
										href='<c:out value="${pageContext.request.contextPath}/teacherPage/${url}" />'>Prev</a></li>
								</c:otherwise>
							</c:choose>
							<c:forEach begin="1" end="${teacherList.pageCount}" step="1"
								...
								<c:choose>
									...
									<c:otherwise>
										...
										<li><a class="page-link"
											href='<c:out value="${pageContext.request.contextPath}/teacherPage/${url}" />'>${tagStatus.index}</a></li>
									</c:otherwise>
								</c:choose>
							</c:forEach>
							<c:choose>
								...
								<c:otherwise>
									...
									<li><a class="page-link"
										href='<c:out value="${pageContext.request.contextPath}/teacherPage/${url}" />'>Next</a></li>
								</c:otherwise>
							</c:choose>
						</ul>
					</div>
