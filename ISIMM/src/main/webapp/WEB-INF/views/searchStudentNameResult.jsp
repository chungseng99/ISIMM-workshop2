							...
							<c:choose>
								...
								<c:otherwise>
									...
									<li><a class="page-link"
										href='<c:out value="${pageContext.request.contextPath}/searchStudentName/${url}?searchStudentName=${search}&submit=Search" />'>Prev</a></li>
								</c:otherwise>
							</c:choose>
							<c:forEach begin="1" end="${studentList.pageCount}" step="1"
								...
								<c:choose>
									...
									<c:otherwise>
										...
										<li><a class="page-link"
											href='<c:out value="${pageContext.request.contextPath}/searchStudentName/${url}?searchStudentName=${search}&submit=Search" />'>${tagStatus.index}</a></li>
									</c:otherwise>
								</c:choose>
							</c:forEach>
							<c:choose>
								...
								<c:otherwise>
									...
									<li><a class="page-link"
										href='<c:out value="${pageContext.request.contextPath}/searchStudentName/${url}?searchStudentName=${search}&submit=Search" />'>Next</a></li>
								</c:otherwise>
							</c:choose>
						</ul>
					</div>
