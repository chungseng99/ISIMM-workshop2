		...
		<div id="sidebar" class="nav-collapse ">
			...
			<ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu"><a href="javascript:;"> <i
					...
					<ul class="sub">
						<li><a href="${pageContext.request.contextPath}/subjectPage">Subject
								List</a></li>
					</ul>
			</ul>
		</div>
	...
	<section id="main-content">
		<section class="wrapper">
			<div class="container pt-3 ">
				<h3>
					<i class="fa fa-angle-right"> &nbsp;Report Card</i>
				</h3>
				<br>
				...
				<div class="container bg-dark text-white pt-3 pb-3">
					...
					<h4 class="mt-2 mb-2">
						...
						<br> Teacher Comment: ${comment }<br>
						<br> Attendance: <fmt:formatNumber type="number" pattern="#0.00" value="${attendance }"/>%<br><br>
						
						<a class="mr-3"
							href="${pageContext.request.contextPath}/printReportCard?userId=${userId }"
							target="_blank"><input type="button" class="btn btn-primary"
							value="Print Report Card"></a>
