	...
	<aside>
		...
		<section class="wrapper">
			<div class="container pt-3 ">
				<h3>
					<i class="fa fa-angle-right"> &nbsp;Search Classroom</i>
				</h3>
				<!-- BASIC FORM ELELEMNTS -->
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							<form class="form-horizontal style-form" action="searchClassName"
								method="get" >
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Search
										By Class Name</label>
									<div class="col-sm-10">
										<input type="text" name="searchClassName" class="form-control"
											placeholder="Search classrooom with class name" />
				...
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							<form class="form-horizontal style-form" action="searchTeacherName"
								method="get" >

								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Search
										By Teacher Name</label>
									<div class="col-sm-10">
										<input type="text" name="searchTeacherName" class="form-control"
											placeholder="Search classrooom with teacher name" />
				...
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							<form class="form-horizontal style-form" action="searchClassForm"
								method="get" >
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Search
										By Form</label>
									<div class="col-sm-10">
										<input type="number" name="searchClassForm" class="form-control"
											placeholder="Search classrooom with form (1-6)"/>
