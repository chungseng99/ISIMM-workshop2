	...
	<section id="main-content">
		<section class="wrapper">
			<div class="container pt-3 ">
				<h3>
					<i class="fa fa-angle-right"> &nbsp;Create fee</i>
				</h3>
					...
					<div class="col-lg-12">
						<div class="form-panel">
							<form class="form-horizontal style-form needs-validation"
								action="createFee" method="post" novalidate="novalidate">
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Fee
										amount</label>
									<div class="col-sm-10">
										<input type="text" name="feeAmount" class="form-control"
											pattern="[0-9]+.[0-9]{2}"
											placeholder="Enter fee amount Eg.(100.00)"
											required="required">
