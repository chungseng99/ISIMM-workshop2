	...
	<aside>
		...
		<section class="wrapper">
			<div class="container pt-3 ">
				<h3>
					<i class="fa fa-angle-right"> &nbsp;Search Teacher</i>
				</h3>
				<!-- BASIC FORM ELELEMNTS -->
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							<form class="form-horizontal style-form" action="searchNameOfTeacher"
								method="get" >
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Search
										By Title</label>
									<div class="col-sm-10">
										<input type="text" name="searchNameOfTeacher" class="form-control"
											placeholder="Search teacher with name" />
				...
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							<form class="form-horizontal style-form" action="searchTeacherIC"
								method="get" >
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Search
										By IC Number</label>
									<div class="col-sm-10">
										<input type="text" name="searchTeacherIC" class="form-control"
											placeholder="Search teacher with IC number" />
				...
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							<form class="form-horizontal style-form" action="searchTeacherEmail"
								method="get" >
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Search
										By Email</label>
									<div class="col-sm-10">
										<input type="text" name="searchTeacherEmail" class="form-control"
											placeholder="Search teacher with email"/>
