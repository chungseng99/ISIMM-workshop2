	...
	<aside>
		...
		<section class="wrapper">
			<div class="container pt-3 ">
				<h3>
					<i class="fa fa-angle-right"> &nbsp;Search Payment</i>
				</h3>
				<!-- BASIC FORM ELELEMNTS -->
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							<form class="form-horizontal style-form" action="searchPaymentByName"
								method="get" >

								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Search By Name</label>
									<div class="col-sm-10">
										<input type="text" name="searchPaymentByName" class="form-control"
											placeholder="Search payment with name" />
				...
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							<form class="form-horizontal style-form" action="searchPaymentByStatus"
								method="get" >
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Search
										By Status</label>
									<div class="col-sm-10">
										<input type="text" name="searchPaymentByStatus" class="form-control"
											placeholder="Search payment with status" />
				...
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							<form class="form-horizontal style-form" action="searchPaymentByFeeId"
								method="get" >
								...
								<div class="form-group">
									<label class="col-sm-2 col-sm-2 control-label">Search
										By Fee Id</label>
									<div class="col-sm-10">
										<input type="text" name="searchPaymentByFeeId" class="form-control"
											placeholder="Search payment with fee id"/>
