...
<c:set value="${userList}" var="userPageList" />
						<table class="table table-hover table-bordered">
							...
							<c:forEach items="${userPageList.pageList}" var="user" varStatus="status">
								<tr>
									...
									<td><a href="edit?userId=${user.userId }"><input
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<a href="deactivate?userId=${user.userId}"><button
  ...
  <c:otherwise>
    ...
    <li><a class="page-link" href='<c:out value="${url}" />'>Prev</a></li>
  </c:otherwise>
</c:choose>
<c:forEach begin="1" end="${userPageList.pageCount}" step="1"  varStatus="tagStatus">
  <c:choose>
    ...
    <c:otherwise>
      ...
      <li><a class="page-link" href='<c:out value="${url}" />'>${tagStatus.index}</a></li>
    </c:otherwise>
  </c:choose>
</c:forEach>
<c:choose>
  ...
  <c:url value="next" var="url" />                  
    <li><a class="page-link" href='<c:out value="${url}" />'>Next</a></li>
  </c:otherwise>
</c:choose>
</ul>
</div>
