	...
	<section id="main-content">
		<section class="wrapper">
			<div class="container pt-3 ">
				<h3>
					<i class="fa fa-angle-right"> &nbsp;View Profile</i>
				</h3>
				<!-- BASIC FORM ELELEMNTS -->
				<div class="row mt">
					<div class="col-lg-12">
						<div class="form-panel">
							<form:form class="form-horizontal style-form needs-validation" modelAttribute="user"
								action="updateProfile" enctype="multipart/form-data"
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<form:input path="icNumber" class="form-control" required="required"
										pattern="[0-9]{12}"	 />
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<form:input path="phoneNumber" class="form-control" required="required"
											pattern="[0-9]{10,11}" />
											 <div class="invalid-feedback">Please enter phone number without hyphen('-')</div>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<form:input path="occupation" class="form-control" required="required"
											 />
											 <div class="invalid-feedback">Please fill out this field</div>
									</div>
								</div>
								<div class="form-group">
									<label for="Role" class="col-sm-2 col-sm-2 control-label">Marital Status</label>
									<div class="radio col-sm-10">
										<label> <form:radiobutton path="maritalStatus" 
												value="Single" required="required" /> Single
										</label>
									</div>
									<div class="radio col-sm-10">
										<label> <form:radiobutton path="maritalStatus" 
									...
									<div class="radio col-sm-10">
										<label> <form:radiobutton path="maritalStatus" 
												value="Divorced" required="required" /> Divorced
										</label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<form:input path="nationality" class="form-control" required="required"
											 />
											 <div class="invalid-feedback">Please fill out this field</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<form:input path="ethnicity" class="form-control" required="required"
											 />
											 <div class="invalid-feedback">Please fill out this field</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<form:textarea path="address" class="form-control" required="required"
											 />
											 <div class="invalid-feedback">Please fill out this field</div>
									</div>
								</div>
								...
								<input type="submit" class="btn btn-primary mr-3" name="Update"
										value="Update">
									<a href="${pageContext.request.contextPath}/clerkDashboard"><input type="button" class="btn btn-primary" name="back"
										value="Back"></a>
								</div>
