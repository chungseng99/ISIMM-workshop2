...
<c:set value="${userList}" var="userPageList" />
  ...
  <c:otherwise>
    ...
    <li><a class="page-link" href='<c:out value="${pageContext.request.contextPath}/searchIC/${url}?searchIC=${search}&submit=Search" />'>Prev</a></li>
  </c:otherwise>
</c:choose>
<c:forEach begin="1" end="${userPageList.pageCount}" step="1"  varStatus="tagStatus">
  <c:choose>
    ...
    <c:otherwise>
      ...
      <li><a class="page-link" href='<c:out value="${pageContext.request.contextPath}/searchIC/${url}?searchIC=${search}&submit=Search" />'>${tagStatus.index}</a></li>
    </c:otherwise>
  </c:choose>
</c:forEach>
<c:choose>
  ...
  <c:url value="next" var="url" />                  
    <li><a class="page-link" href='<c:out value="${pageContext.request.contextPath}/searchIC/${url}?searchIC=${search}&submit=Search" />'>Next</a></li>
  </c:otherwise>
</c:choose>
</ul>
</div>
